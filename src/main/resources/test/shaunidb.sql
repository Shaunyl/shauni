...
CREATE TABLE Sha.MontbsRunMessages (
    run_id INT NOT NULL,
    tbs_run_id INT NOT NULL,
    delta_used_pct DOUBLE NOT NULL,
    CONSTRAINT montbs_run_id_key FOREIGN KEY (run_id, tbs_run_id) REFERENCES Sha.MontbsRuns(run_id, tbs_run_id)
);
